...
lambda1, n_r, n_i = loadtxt("hBNgetfdtdindexMO6_MC3Z1_8.txt", usecols=(0,1,2),  unpack = True)
...
lambda2, TFDTD= loadtxt("hBN_RTMO6_MC3Z1_8.txt", usecols=(0,2,),  unpack = True)
...
plot(lambda2, TFDTD,  label=r'$T_{FDTD: getfdtdindex MO6 MC3 Z 1.8 u m}$', color='blue' )
