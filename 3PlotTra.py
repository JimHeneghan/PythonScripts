...
ax0.set_xticks([])
ax0.set_yticks([])
ax0.set_ylabel('Transmittance', rotation='vertical', fontsize = '70', labelpad = 50)
...
for i in range (0, 20):
	...
	lam, A = loadtxt(namy, usecols=(0,2), skiprows= 1, unpack =True)
	print(namy)
	lam = 1/(lam*1e-4)
...
ax2.set_yticks(np.arange(0.1, 0.5, 0.1))
...
ax3.set_yticks(np.arange(0.1, 0.5, 0.1))
...
plt.savefig("Fig_S3_Tra_ALLines.png")
plt.savefig("Fig_S3_Tra_ALLines.pdf")
