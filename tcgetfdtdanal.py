...
lambda1, ReEps, ImEps = loadtxt("hBNgetfdtdindexConstZ.txt", usecols=(0,1,2),  unpack = True)
...
lambda2, TFDTD= loadtxt("hBN_RTMO7analMeshZ3.txt", usecols=(0,2,),  unpack = True)
...
plot(lambda2, TFDTD,  label=r'$T_{FDTD: getmaterial M7 Alanytic Model Mesh Z = 3 um}$', color='blue' )
