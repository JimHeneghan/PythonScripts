...
for z in range (0, len(thick)):   
    ...
    plt.plot(k, R_exp, linewidth = 2, color = shades[z], label = r"$\rm \ hBN \ thicknes \ is \ %d \ nm \ thick$" %thick[z])
...
plt.savefig("hBNAllThickBaF2Digi_WN.png")
plt.savefig("hBNAllThickBaF2Digi_WN.pdf")
plt.show()
