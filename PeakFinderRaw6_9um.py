...
fig, ax = plt.subplots(1, figsize = (9, 8),constrained_layout=True)
z = 8
for k in range (0, 1):
	...
	for i in range(0,len(E)-1):
	    if ((E[i] > E[i-1]) & (E[i] > E[i+1])&(E[i]> 0.2)):#&(E[i]**2 > (max(E**2)-min(E**2))/2)):
	...
	ax.plot(X*1e6, E, color = 'black', linewidth = 4)
	...
	z = z + 1
plt.savefig("6_9PeaksChartWALLLines.png") 
	# plt.clf()