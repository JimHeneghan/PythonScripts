...
ax1.set_ylim(-50,50)
ax1.set_ylabel(r'$\rm Re \ \mathit{\epsilon}$', fontsize = '70')   
...
ax2.set_ylabel(r'$\rm Im \ \mathit{\epsilon}$', fontsize = '70') 
...
ax3.set_ylabel(r"$R,T,A$", fontsize = '70') 
...
plt.savefig("hBN_Vac_RTA_Dispersion.png")
plt.savefig("hBN_Vac_RTA_Dispersion.pdf")
