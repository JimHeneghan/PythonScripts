...
ax[1].plot(k/100, real(epsk),  color = "red", linewidth=3, label = r"$\epsilon_{\perp} $ Zhao")
ax[1].plot(k/100, real(epskJJ),  color = "black" ,label = r"$\epsilon_{\perp} $ Jiang")
ax[1].plot(k/100, real(epskz), color = "red",  linewidth=3, label = r"$\epsilon_{\parallel}$ Zhao")
ax[1].plot(k/100, real(epskz2), color = "black", label = r"$\epsilon_{\parallel}$ Jiang")
ax[1].set_ylabel(r"Re$(\epsilon)$", fontsize = '30')
...
ax[0].plot(k/100, imag(epsk), color = "red", linewidth=3, label = r"$\epsilon_{\perp}$ Zhao" )
ax[0].plot(k/100, imag(epskJJ), color = "black" , label = r"$\epsilon_{\perp} $ Jiang")
ax[0].plot(k/100, imag(epskz), color = "red", linewidth=3, label = r"$\epsilon_{\parallel}$ Zhao")
ax[0].plot(k/100, imag(epskz2), color = "black" , label = r"$\epsilon_{\parallel}$ Jiang")
ax[0].set_ylabel(r"Im$(\epsilon)$", fontsize = '30')
ax[0].set_xlabel(r"$\rm Frequency \ cm^{-1}$", fontsize = '30')
ax[0].legend(loc= 'upper left', fontsize='18')
plt.savefig("/halhome/jimheneghan/UsefulImages/ImEpsReEpsTSpectraCombo.pdf")
plt.savefig("/halhome/jimheneghan/UsefulImages/ImEpsReEpsTSpectraCombo.png")
show()
