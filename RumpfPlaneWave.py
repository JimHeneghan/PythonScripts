...
freq   = np.loadtxt("freq.txt",  usecols=(0), skiprows= 0, unpack =True)

ExR    = np.loadtxt("ExRef.txt", usecols=(0), skiprows= 0, unpack =True)
ExI    = np.loadtxt("ExRef.txt", usecols=(1), skiprows= 0, unpack =True)

EyR    = np.loadtxt("EyRef.txt", usecols=(0), skiprows= 0, unpack =True)
EyI    = np.loadtxt("EyRef.txt", usecols=(1), skiprows= 0, unpack =True)

EzR    = np.loadtxt("EzRef.txt", usecols=(0), skiprows= 0, unpack =True)
EzI    = np.loadtxt("EzRef.txt", usecols=(1), skiprows= 0, unpack =True)

ExTR   = np.loadtxt("ExTra.txt", usecols=(0), skiprows= 0, unpack =True)
ExTI   = np.loadtxt("ExTra.txt", usecols=(1), skiprows= 0, unpack =True)

EyTR   = np.loadtxt("EyTra.txt", usecols=(0), skiprows= 0, unpack =True)
EyTI   = np.loadtxt("EyTra.txt", usecols=(1), skiprows= 0, unpack =True)

EzTR   = np.loadtxt("EzTra.txt", usecols=(0), skiprows= 0, unpack =True)
EzTI   = np.loadtxt("EzTra.txt", usecols=(1), skiprows= 0, unpack =True)

ExIncR = np.loadtxt("ExInc.txt", usecols=(0), skiprows= 0, unpack =True)
ExIncI = np.loadtxt("ExInc.txt", usecols=(1), skiprows= 0, unpack =True)

EyIncR = np.loadtxt("EyInc.txt", usecols=(0), skiprows= 0, unpack =True)
EyIncI = np.loadtxt("EyInc.txt", usecols=(1), skiprows= 0, unpack =True)

EzIncR = np.loadtxt("EzInc.txt", usecols=(0), skiprows= 0, unpack =True)
EzIncI = np.loadtxt("EzInc.txt", usecols=(1), skiprows= 0 , unpack =True)
...
plt.plot((c0/freq)*1e6, REF, label = r'$\rm R_{XFDTD}$', color = "red", linewidth = 6)
...
plt.savefig("XFAgonSiRTANoZoom.pdf")
plt.savefig("XFAgonSiRTANoZoom.png")
