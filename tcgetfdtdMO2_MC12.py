...
lambda1, n_r, n_i = loadtxt("hBNgetfdtdindexMO2.txt", usecols=(0,1,2),  unpack = True)
...
plot(lambda1, T1, label=r'$T_{Theory MO2 MC12}$', color='red')
plot(lambda2, TFDTD,  label=r'$T_{FDTD: getfdtdindex MO2 MC12}$', color='blue' )
