...
plt.tight_layout()
Lambda, R, T, RT = loadtxt("AgonSi2_3PitchNoExStabL.txt", usecols=(0,1,2,3), skiprows= 0, unpack =True)
...
plt.savefig("StabilizedLayersLongNoExtend.pdf")
plt.savefig("StabilizedLayersLongNoExtend.png")
