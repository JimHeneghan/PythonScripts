...
plot(1e6/k0, R, label=r'$R_{Macleod, Jiang_{\epsilon}}$', color='red')
plot(1e6/k0, T,  label=r'$T_{Macleod: Jiang_{\epsilon}}$', color='limegreen')
plot(1e6/k0, R + T,  label=r'$R + T}}$', color='blue')
