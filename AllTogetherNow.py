...
ax2.plot(wn,R, label = r'$\rm R_{FDTD}$', color = "red", linewidth = 3)
ax2.plot(wn,T, label = r'$\rm T_{FDTD}$', color = "black", linewidth = 3)
...
plt.tight_layout()
plt.savefig("AllTogetherLumWorking.png")
plt.savefig("AllTogetherLumWorking.pdf")
# plt.show()
