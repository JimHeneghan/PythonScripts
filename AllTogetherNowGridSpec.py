...
ax2.plot(wn,R, label = r'$\rm R_{Lumerical:  Correct \ \gamma}$', color = "red", linewidth = 3)
ax2.plot(wn,T, label = r'$\rm T_{Lumerical: Correct \ \gamma}$', color = "black", linewidth = 3)
...
# plt.tight_layout()
plt.savefig("AllTogetherPixOption3WN.png")
plt.savefig("AllTogetherPixOption3WN.pdf")
# plt.show()
